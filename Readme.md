...
В будущем эти фичи можно использовать, как стандартные входные данные для нейронной сети, а на выходе сделать бинарную классификацию с решением, давать кредит или нет. При достаточно большом количестве примеров, нейронная сеть сможет найти намного более точные веса, чем описаны в этом файле.
